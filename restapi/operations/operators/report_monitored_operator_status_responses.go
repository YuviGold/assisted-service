...
// WithPayload adds the payload to the report monitored operator status o k response
func (o *ReportMonitoredOperatorStatusOK) WithPayload(payload *models.Cluster) *ReportMonitoredOperatorStatusOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the report monitored operator status o k response
func (o *ReportMonitoredOperatorStatusOK) SetPayload(payload *models.Cluster) {
	o.Payload = payload
}
