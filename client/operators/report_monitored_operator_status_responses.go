...
func (o *ReportMonitoredOperatorStatusOK) Error() string {
	return fmt.Sprintf("[PUT /clusters/{cluster_id}/monitored_operators][%d] reportMonitoredOperatorStatusOK  %+v", 200, o.Payload)
}

func (o *ReportMonitoredOperatorStatusOK) GetPayload() *models.Cluster {
	return o.Payload
}
